...
9. Find the mod or mods that you want to add and select them
...
1. Find the mod or mods that you want to add from the [list of Fabric mods on CurseForge](https://curseforge.com/minecraft/search?gameVersionTypeId=4)
