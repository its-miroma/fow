# How to Update: Minecraft Launcher (vanilla)
...
2. Run the installer. You may get a prompt from your OS: allow the installer to run [Why did I get this prompt?](vanilla.md)
