# How to Reset Options: MultiMC

1. Open **MultiMC**
2. Right-click on the FO instance
3. Click on **Minecraft Folder**
4. If you want to reset mod options, then delete the `config` folder
5. If you want to reset vanilla options, then delete the `options.txt` file
