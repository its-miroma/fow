...
4. Select `version 0.16.7` of the Fabric Loader
...
FO consists of mods, configuration and resource packs, and all three are necessary. [What does the pack contain?](../../info/README.md)
