...
2. Open the installer. If you get a prompt from your OS, then allow the installer to run. [Why did I get this prompt?](vanilla.md)
   * On Windows: Open the `exe` file, then click on **More info**, then click on **Run anyway**
   * On macOS: Open the `dmg` file, then right-click on the **FO Installer**, then click on **Open**, then if prompted click on **Open** again
...
16. Copy all folders from the extracted `zip` file to the `.minecraft` folder that you opened in _step 8_. [Why do I need to copy everything over?](vanilla.md#why-do-i-need-to-copy-everything-over)
...
16. Copy all folders from the `zip`'s `minecraft` folder to the `.minecraft` folder that you opened in _step 6_. [Why do I need to copy everything over?](vanilla.md#why-do-i-need-to-copy-everything-over)
17. If you're asked to replace files, replace them
18. If you want the [recommended FO settings](../../info/options.md), delete `options.txt`. This will reset your vanilla options (resource packs, language, keybinds...) but you can reapply them later
19. Go back to the **Minecraft Launcher**
...
The MultiMC `zip` file is a packaged instance for [MultiMC](multimc.md#how-does-it-work), but it was also used for manual installation up to FO 6.0.0. This file was hosted on CurseForge because downloads from there support FO with monetary benefits.
