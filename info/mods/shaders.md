...
FO supports shaders with [Iris](https://modrinth.com/mod/iris). To install a shader:

1. Download any shader. You can get some [shaders from Modrinth](https://modrinth.com/shaders?g=categories:iris) or [shaders from CurseForge](https://www.curseforge.com/minecraft/search?class=shaders). You should get a `zip` file
...
Fabulous shaders are vanilla shaders that work by enabling **Fabulous!** graphics in video settings.
...
* [Fabulous Shaders](https://sildurs-shaders.github.io/downloads) by Sildur ([Configuration instructions](https://sildurs-shaders.github.io/install/#fabulous))
...
The ones that do not work may be replicated by [adding a mod](../../how-to/add-mods/).
...
Canvas shaders are a kind of shader optimized for powerful computers, to be used with the [Canvas Renderer mod](https://www.curseforge.com/minecraft/mc-mods/canvas-renderer). Examples include:
...
3. [Install the shader](#shaders) you want
