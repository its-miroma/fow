...
While telemetry is not necessarily bad, as it may help developers better support their users' devices (for example when it comes to performance), it may be unwanted and unexpected.
...
* In accordance to the [Transparency principle](../about/#transparency), we believe that telemetry should be opt-in
