...
In accordance to the [Accessibility principle](../README.md#accessibility), one of FO's objectives is making it accessible to everyone, regardless of their language. That's why we support and welcome translations of FO and of its mods.
...
11. Start translating the values inside of the quotes, on the right side of the colon. For example:
   ...
   Translate `Coolmods Options` only!
12. Commit the file
...
Sodium does not support translations natively, but the creators of Sodium Extra and FO have created an independent resource pack that adds translations to Sodium. FO includes the [Translations for Sodium resource pack](../../info/resource-packs/#translations-for-sodium).

To translate Sodium, open its [unofficial page on Crowdin](https://crowdin.com/project/sodium-fabric). Translations are published every Saturday, and FO versions after that will include them.
...
1. Join the [FO project on Crowdin](https://crowdin.com/project/fabulously-optimized)
2. Translate the files you prefer. Files are sorted according to the priority
3. Vote for existing suggestions with the ➕ and ➖ buttons
...
* Translations must be fully visible in a maximised Full HD 1920×1080 window, with the default font, or with the Unicode font if required. You can emulate such a window in-game:
   1. Open **Options...**
   ...
   7. Click on **Done**
* The [online translations tester](https://fabulously-optimized.github.io/Mod-Menu-Helper-Size-Checker) may help, but does not replace in-game testing
* Feel free to rephrase sentences if you see fit
* In the options row, list as many of them as you can
...
3. Click on the **Download** button. You'll get a `la_ng.json` file
4. In Minecraft, open **Options...**
5. Open **Resource Packs...**
6. Select the "Mod Menu Helper" resource pack
7. Click on **Open Pack Folder**
8. Open the `Mod Menu Helper.zip` file. If the `zip` file gets extracted, open the extracted folder
9. Navigate to `assets/fo/lang`
10. Drag the file you downloaded in _step 3_ and drop it into the folder you opened in _step 9_
11. In Minecraft, if the `zip` file got extracted in _step 8_, activate it
12. Click on **Done** twice
...
2. Find the latest ["New Crowdin updates" pull request on GitHub](https://github.com/Fabulously-Optimized/fabulously-web/pulls?q=is%3Apr+is%3Aopen+New+Crowdin+updates)
