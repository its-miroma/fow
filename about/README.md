...
Fabulously Optimized is simple modpack for Minecraft: Java Edition, focusing on performance and graphics enhancements.
...
FO should only give you the essential tools and fixes to your game, so it does not include any new content, nor any opinionated extras (like minimaps, armor HUD, more sounds...). FO tries to maintain neutrality, without taking sides.
...
FO is [open-source](https://github.com/Fabulously-Optimized/fabulously-optimized), and so is most of its mods. Its [content](../info/) is clearly listed, its [changes over time](https://github.com/Fabulously-Optimized/fabulously-optimized/blob/main/CHANGELOG.md) are clearly outlined, and it's ready to inform its users about new game features (such as [Player Reporting](../info/mods/player-reporting.md)) and to alarm its users about vulnerabilities affecting the game.

## Updates

FO receives fast updates thanks to [being a Fabric modpack](fabric.md). It's consistently one of the first modpacks to upgrade to newer Minecraft versions.
